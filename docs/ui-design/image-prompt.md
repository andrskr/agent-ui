...
01: Smoke group, Overview active, action "n Run all tasks", compact table of Baseline/Context/Repair, status, agent time, estimated cost. Summary "3 tasks · 3 ready". No repeated prose.
