...
1. After you build or edit the task UI, run `vp lint src --fix` from the app directory. Use the
   normal fixes only. Read any errors that remain and fix the source. Do not enable unsafe fixes.
