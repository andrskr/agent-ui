...
The `settings-and-gallery` suite selects only cases 9 and 10 with both variants.

Account settings: [Opus 4.8 high](../reports/account-settings/opus-4-8-high/report.html) and
[Sonnet 5 high](../reports/account-settings/sonnet-5-high/report.html). All four attempts passed
automated checks. Initial-state screenshots and capture notes are saved beside both reports. No
manual interaction tests were performed.
